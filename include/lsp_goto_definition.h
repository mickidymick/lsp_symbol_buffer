...
static void goto_definition_request(yed_frame *frame);
static void goto_definition_get_range(const json &result, yed_event *event);
static void goto_definition_pmsg(yed_event *event);
