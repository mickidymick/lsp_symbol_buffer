...
static void goto_declaration_request(yed_frame *frame);
static void goto_declaration_get_range(const json &result, yed_event *event);
static void goto_declaration_pmsg(yed_event *event);
