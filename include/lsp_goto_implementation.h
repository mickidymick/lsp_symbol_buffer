...
static void goto_implementation_request(yed_frame *frame);
static void goto_implementation_get_range(const json &result, yed_event *event);
static void goto_implementation_pmsg(yed_event *event);
